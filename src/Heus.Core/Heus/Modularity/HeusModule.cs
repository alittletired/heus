...
{
    public abstract class HeusModule : 
        IHeusModule,
        ...
        IPostConfigureServices
    {
        ...
        protected internal ServiceConfigurationContext ServiceConfigurationContext
        {
            get
            {
                ...
                {
                    throw new HeusException($"{nameof(ServiceConfigurationContext)} is only available in the {nameof(ConfigureServices)}, {nameof(PreConfigureServices)} and {nameof(PostConfigureServices)} methods.");
                }
        ...
        public static bool IsAbpModule(Type type)
        {
            ...
            return
                ...
                typeof(IHeusModule).GetTypeInfo().IsAssignableFrom(type);
        }
